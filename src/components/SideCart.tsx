            ...
            <div className="sm:px-8 sm:py-6">
                ...
                <li key={item.id} className="flex flex-col space-y-3 pt-3 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                    <div className="shrink-0 relative mt-1">
                        ...
                        <img className="h-16 w-16 max-w-full rounded-lg object-cover" src="https://images.unsplash.com/photo-1588484628369-dd7a85bfdc38?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxzZWFyY2h8MTh8fHNuZWFrZXJ8ZW58MHx8MHx8&auto=format&fit=crop&w=150&q=60" alt="" />
                    </div>
