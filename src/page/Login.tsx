...
const Login: React.FC = () => {
    ...
    return (
        <section className="flex items-center justify-center bg-gray-50 dark:bg-gray-900 md:h-screen lg:py-0">
      <div className="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
          <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
              ...
              <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6" action="#">
                  ...
                  <button type="submit" className="w-full text-gray-600 bg-gray-300 hover:bg-primary-700 font-medium rounded-lg text-sm px-5 py-2.5 text-center">Login</button>
